...
/** @internal Copied from gl.FRAGMENT_SHADER */
export const _FRAGMENT_SHADER: 0x8B30 = 0x8B30;
/** @internal Copied from gl.VERTEX_SHADER */
export const _VERTEX_SHADER: 0x8B31 = 0x8B31;
...
> implements Disposable, Disposable {
  ...
  setTexture(name: TUniformKey, value: WebGLUniformLocation): void {
    this.gl.uniform1i(this.uniforms.get(name)!, value as GLint);
  }
}
